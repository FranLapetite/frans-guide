...
const PHOTOSHOOT = {
  en: {
    ...
    price: 'From 120€',
    priceNote: 'sessions from 30 min · up to 40 retouched photos',
    ...
    features: [
      'Express, couple, birthday & family sessions',
      'Iconic and hidden locations',
      'Photoshoot + guided tour combo (280€)',
      'Wedding packages from 250€',
    ],
  ...
  fr: {
    ...
    price: 'Dès 120€',
    priceNote: 'séances dès 30 min · jusqu\'à 40 photos retouchées',
    ...
    features: [
      'Séances express, couple, anniversaire & famille',
      'Lieux iconiques et cachés',
      'Combo séance photo + visite guidée (280€)',
      'Formules mariage dès 250€',
    ],
  ...
  pt: {
    ...
    priceNote: 'sessões a partir de 30 min · até 40 fotos retocadas',
    ...
    features: [
      'Sessões express, casal, aniversário & família',
      'Locais icônicos e escondidos',
      'Combo ensaio + tour guiado (280€)',
      'Pacotes de casamento a partir de 250€',
    ],
  ...
  es: {
    ...
    price: 'Desde 120€',
    priceNote: 'sesiones desde 30 min · hasta 40 fotos retocadas',
    ...
    features: [
      'Sesiones express, pareja, cumpleaños & familia',
      'Lugares icónicos y escondidos',
      'Combo sesión + tour guiado (280€)',
      'Paquetes de boda desde 250€',
    ],
...
const AUDIO_TOURS = [
  ...
  },
  {
    id: 'le-marais',
    title: {
      en: 'Le Marais & Place des Vosges',
      fr: 'Le Marais & Place des Vosges',
      pt: 'Le Marais & Place des Vosges',
      es: 'Le Marais & Place des Vosges',
    },
    subtitle: {
      en: 'From Centre Pompidou to Place de la Bastille',
      fr: 'Du Centre Pompidou à la Place de la Bastille',
      pt: 'Do Centre Pompidou à Place de la Bastille',
      es: 'Del Centre Pompidou a la Place de la Bastille',
    },
    duration: '50 min',
    distance: '2.0 km',
    stops: 9,
  ...
  },
  {
    ...
    subtitle: {
      ...
      fr: 'De la Place Blanche au panorama sur Paris',
      pt: 'Da Place Blanche ao panorama de Paris',
      es: 'De la Place Blanche al panorama de París',
    },
    duration: '50 min',
    distance: '2.2 km',
    stops: 9,
  ...
  },
  {
    id: 'louvre',
    title: {
      en: 'Louvre & Tuileries Gardens',
      fr: 'Louvre & Jardins des Tuileries',
      pt: 'Louvre & Jardins das Tuileries',
      es: 'Louvre & Jardines de las Tullerías',
    },
    subtitle: {
      en: 'From Place de la Concorde to the Louvre Pyramid',
      fr: 'De la Place de la Concorde à la Pyramide du Louvre',
      pt: 'Da Place de la Concorde à Pirâmide do Louvre',
      es: 'De la Place de la Concorde a la Pirámide del Louvre',
    },
    duration: '45 min',
    distance: '2.2 km',
    stops: 9,
