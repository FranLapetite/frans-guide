...
const AUDIO_TOURS = [
  ...
  },
  {
    ...
    subtitle: {
      en: 'From Rue des Rosiers to Place des Vosges',
      fr: 'De la Rue des Rosiers à la Place des Vosges',
      pt: 'Da Rue des Rosiers à Place des Vosges',
      es: 'De la Rue des Rosiers a la Place des Vosges',
    },
    duration: '50 min',
    distance: '2.0 km',
    stops: 9,
  ...
  },
  {
    ...
    subtitle: {
      en: 'From Place Blanche to the View of Paris',
